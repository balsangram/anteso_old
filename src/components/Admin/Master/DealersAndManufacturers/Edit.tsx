...
const EditDealerAndManufacturer = () => {
    ...
    return (
        <>
            ...
            <Formik
                initialValues={{
                    customerName: dealersAndManufacturers[0].customerName,
                    city: dealersAndManufacturers[0].city,
                    type: dealersAndManufacturers[0].type,
                    machineAndPrice: dealersAndManufacturers[0].machineAndPrice,
                }}
