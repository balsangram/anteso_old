        ...
        <>
            ...
            >
                {({ errors, submitCount, touched }) => (
                    <Form className="space-y-5 panel">
                        {/* <dv className="panel"> */}
                                ...
                                <div className="grid grid-cols-2 gap-2 mt-2">
                                    {['QA', 'Registration', 'Procurement', 'License', 'Tatkal QA', 'Remote Location'].map((service) => (
                                        <label key={service} className="flex items-center space-x-2">
                                            <Field type="checkbox" name="services" value={service} className="form-checkbox" />
                                            <span>{service}</span>
                                        </label>
                                    ))}
                                </div>
                                {submitCount > 0 && errors.services && <p className="text-red-500 text-sm mt-1">{errors.services}</p>}
                            </div>
                        </div>
